...
No Nintendo 64DD-specific RomM asset overrides are implemented by the fallback installer. Standard plugin metadata and asset behavior applies.
...
- If a dedicated Nintendo 64DD installer is added later, this document should be replaced with platform-specific documentation.
