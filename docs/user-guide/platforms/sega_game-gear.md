...
No Sega Game Gear-specific RomM asset overrides are implemented by the fallback installer. Standard plugin metadata and asset behavior applies.
...
- If a dedicated Sega Game Gear installer is added later, this document should be replaced with platform-specific documentation.
