...
No Nintendo Game Boy Advance-specific RomM asset overrides are implemented by the fallback installer. Standard plugin metadata and asset behavior applies.
...
- If a dedicated Nintendo Game Boy Advance installer is added later, this document should be replaced with platform-specific documentation.
